    ...
    def train_model(self):
        ...
        for epoch in range(self.args.max_epoch):
            ...
            if f1 > best_f1:
                ...
                torch.save({'state_dict': self.model.state_dict()}, self.args.generated_param_directory + " %s_%s_epoch_%d_f1_%.4f.model" %(self.model.args.model_name, self.args.dataset_name, epoch, result['f1']))
                best_f1 = f1
